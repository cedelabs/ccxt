...
async function exportEverything () {
    ...
    const typeExports = ['Market', 'MarketInterface', 'Trade' , 'Fee', 'Ticker', 'OrderBook', 'Order', 'Transaction', 'Tickers', 'Currency', 'CurrencyInterface', 'Balance', 'DepositAddress', 'WithdrawalResponse', 'DepositAddressResponse', 'OHLCV', 'Balances', 'PartialBalances', 'Dictionary', 'MinMax', 'Position', 'CustomThrottlePriority', 'Throttler', 'FundingRateHistory', 'Liquidation', 'FundingHistory', 'MarginMode', 'Greeks']
